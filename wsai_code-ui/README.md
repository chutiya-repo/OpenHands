...
```bash
# npm
npm install @wsai_code/ui

# yarn
yarn add @wsai_code/ui

# pnpm
pnpm add @wsai_code/ui

# bun
bun add @wsai_code/ui
```

## Quick Start

```tsx
import { Button, Typography } from "@wsai_code/ui";
import "@wsai_code/ui/styles";
...
# Replace `path/to/wsai_code-ui-x.x.x.tgz` with the actual path to the generated `.tgz` file.
npm install path/to/wsai_code-ui-x.x.x.tgz
```
