"""File operations module for WSAI CODE agent.

This module provides a collection of file manipulation skills that enable the WSAI CODE
...
from wsai_code.linter import DefaultLinter, LintResult
