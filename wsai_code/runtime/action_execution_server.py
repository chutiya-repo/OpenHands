...
It is responsible for executing actions received from WSAI CODE backend and producing observations.
...
from wsai_code_aci.editor.editor import OHEditor
from wsai_code_aci.editor.exceptions import ToolError
from wsai_code_aci.editor.results import ToolResult
from wsai_code_aci.utils.diff import get_diff
from pydantic import BaseModel
from starlette.background import BackgroundTask
from starlette.exceptions import HTTPException as StarletteHTTPException
from uvicorn import run

from wsai_code.core.config.mcp_config import MCPStdioServerConfig
from wsai_code.core.exceptions import BrowserUnavailableException
from wsai_code.core.logger import get_uvicorn_json_log_config
...
from wsai_code.events.serialization import event_from_dict, event_to_dict
from wsai_code.runtime.browser import browse
from wsai_code.runtime.browser.browser_env import BrowserEnv
from wsai_code.runtime.file_viewer_server import start_file_viewer_server

# Import our custom MCP Proxy Manager
from wsai_code.runtime.mcp.proxy import MCPProxyManager
from wsai_code.runtime.plugins import ALL_PLUGINS, JupyterPlugin, Plugin, VSCodePlugin
from wsai_code.runtime.utils import find_available_tcp_port
from wsai_code.runtime.utils.bash import BashSession
from wsai_code.runtime.utils.files import insert_lines, read_lines
from wsai_code.runtime.utils.memory_monitor import MemoryMonitor
from wsai_code.runtime.utils.runtime_init import init_user_and_working_directory
from wsai_code.runtime.utils.system_stats import (
    get_system_stats,
    update_last_execution_time,
)
from wsai_code.utils.async_utils import call_sync_from_async, wait_all

if sys.platform == 'win32':
    from wsai_code.runtime.utils.windows_bash import WindowsPowershellSession
...
class ActionExecutor:
    ...
    async def ainit(self):
        ...
        if 'agent_skills' in self.plugins and 'jupyter' in self.plugins:
            obs = await self.run_ipython(
                IPythonRunCellAction(
                    code='from wsai_code.runtime.plugins.agent_skills.agentskills import *\n'
                )
            )
    ...
    async def _init_bash_commands(self):
        ...
        # Hack: for some reason when you set the wsai_code user to anything but root, tmux changes out
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--username', type=str, help='User to run as', default='wsai_code'
    )
