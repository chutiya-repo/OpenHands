...
from wsai_code.runtime.utils import git_changes, git_diff

GIT_CHANGES_CMD = 'python3 /wsai_code/code/wsai_code/runtime/utils/git_changes.py'
GIT_DIFF_CMD = (
    'python3 /wsai_code/code/wsai_code/runtime/utils/git_diff.py "{file_path}"'
)
