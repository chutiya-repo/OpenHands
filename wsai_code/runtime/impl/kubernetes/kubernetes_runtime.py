...
from wsai_code.core.logger import DEBUG
...
POD_NAME_PREFIX = 'wsai_code-runtime-'
POD_LABEL = 'wsai_code-runtime'
...
class KubernetesRuntime(ActionExecutionClient):
    ...
    def _get_runtime_pod_manifest(self):
        ...
        command = get_action_execution_server_startup_command(
            ...
            override_user_id=0,  # if we use the default of app_config.run_as_wsai_code then we cant edit files in vscode due to file perms.
