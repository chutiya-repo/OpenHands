...
if sys.platform == 'win32':
    try:
        from wsai_code.runtime.utils.windows_exceptions import DotNetMissingError
        from wsai_code.runtime.utils.windows_bash import WindowsPowershellSession  # isort: skip
...
The .NET SDK and PowerShell are required for WSAI CODE CLI on Windows.
...
class CLIRuntime(Runtime):
    ...
    def __init__(
        ...
        if self.config.workspace_base is not None:
            ...
            self._workspace_path = tempfile.mkdtemp(
                prefix=f'wsai_code_workspace_{sid}_'
            )
    ...
    async def call_tool_mcp(self, action: MCPAction) -> Observation:
        ...
        from wsai_code.mcp.utils import call_tool_mcp as call_tool_mcp_handler
        from wsai_code.mcp.utils import create_mcp_clients
    ...
    async def delete(cls, conversation_id: str) -> None:
        ...
        prefix = f'wsai_code_workspace_{conversation_id}_'
