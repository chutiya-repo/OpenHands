...
This module provides a manager class for handling FastMCP proxy instances in WSAI CODE, including initialization, configuration, and mounting to FastAPI applications.
