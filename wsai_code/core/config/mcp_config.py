...
class WSAI CODEMCPConfig:
    @staticmethod
    def add_search_engine(app_config: 'WSAI CODEConfig') -> MCPStdioServerConfig | None:
        ...
        # Do not add search engine to MCP config in SaaS mode since it will be added by the WSAI CODE server
        return None
    ...
    def create_default_mcp_server_config(
        ...
        """
        stdio_servers = []
        search_engine_stdio_server = WSAI CODEMCPConfig.add_search_engine(config)
...
wsai_code_mcp_config_cls = os.environ.get(
    'WSAI_CODE_MCP_CONFIG_CLS',
    'wsai_code.core.config.mcp_config.WSAI CODEMCPConfig',
)

WSAI CODEMCPConfigImpl = get_impl(WSAI CODEMCPConfig, wsai_code_mcp_config_cls)
