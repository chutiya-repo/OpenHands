...
from wsai_code.core.logger import LOG_DIR
...
class LLMConfig(BaseModel):
    ...
    Attributes:
        ...
        custom_llm_provider: The custom LLM provider to use. This is undocumented in wsai_code, and normally not used. It is documented on the litellm side.
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        # Azure issue: https://github.com/WSAI CODE/WSAI CODE/issues/7755
