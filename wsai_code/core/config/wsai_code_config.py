...
class WSAI CODEConfig(BaseModel):
    ...
    Attributes:
        ...
        run_as_wsai_code: Whether to run as wsai_code.
        ...
        mcp_host: Host for WSAI CODE' default MCP server
    ...
    file_store_path: str = Field(default='~/.wsai_code')
    ...
    run_as_wsai_code: bool = Field(default=True)
    ...
    git_user_name: str = Field(
        default='wsai_code', description='Git user name for commits made by the agent'
    )
    git_user_email: str = Field(
        default='wsai_code@all-hands.dev',
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        if not WSAI CODEConfig.defaults_dict:  # Only set defaults_dict if it's empty
            WSAI CODEConfig.defaults_dict = model_defaults_to_dict(self)
