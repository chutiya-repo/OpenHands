...
from wsai_code.events.event import Event, RecallType
...
class ConversationMemory:
    ...
    def _process_action(
        ...
        Args:
            action: The action to convert. Can be one of:
                ...
                - FileReadAction: For reading files using wsai_code-aci commands
    ...
    def _process_observation(
        ...
        - FileReadObservation: Formats file reading results from wsai_code-aci
        ...
        if isinstance(obs, CmdOutputObservation):
            ...
            )  # Content is already truncated by wsai_code-aci
