...
from wsai_code.core.exceptions import LLMResponseError
from wsai_code.events.event import Event
from wsai_code.events.observation import CmdOutputMetadata
from wsai_code.events.serialization import event_to_dict
from wsai_code.llm.metrics import Metrics


class WSAI CODEJSONEncoder(json.JSONEncoder):
...
_json_encoder = WSAI CODEJSONEncoder()
...
def dumps(obj, **kwargs):
    ...
    if 'cls' not in encoder_kwargs:
        encoder_kwargs['cls'] = WSAI CODEJSONEncoder
