...
from wsai_code.llm import bedrock


def get_supported_llm_models(config: WSAI CODEConfig) -> list[str]:
    ...
    wsai_code_models = [
        'wsai_code/claude-sonnet-4-20250514',
        'wsai_code/claude-sonnet-4-5-20250929',
        'wsai_code/gpt-5-2025-08-07',
        'wsai_code/gpt-5-mini-2025-08-07',
        'wsai_code/claude-opus-4-20250514',
        'wsai_code/claude-opus-4-5-20251101',
        'wsai_code/gemini-2.5-pro',
        'wsai_code/o3',
        'wsai_code/o4-mini',
        'wsai_code/devstral-small-2505',
        'wsai_code/devstral-small-2507',
        'wsai_code/devstral-medium-2507',
        'wsai_code/kimi-k2-0711-preview',
        'wsai_code/qwen3-coder-480b',
    ]
    model_list = wsai_code_models + model_list
