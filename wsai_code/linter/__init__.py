...
- The detailed implementation of the linter can be found at: https://github.com/WSAI CODE/wsai_code-aci.
"""

from wsai_code_aci.linter import DefaultLinter, LintResult
