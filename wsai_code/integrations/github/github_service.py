...
from wsai_code.integrations.github.service import (
    GitHubBranchesMixin,
    GitHubFeaturesMixin,
    GitHubPRsMixin,
    GitHubReposMixin,
...
class GitHubService(
    ...
    This is an extension point in WSAI CODE that allows applications to customize GitHub
...
github_service_cls = os.environ.get(
    'WSAI_CODE_GITHUB_SERVICE_CLS',
    'wsai_code.integrations.github.github_service.GitHubService',
)
