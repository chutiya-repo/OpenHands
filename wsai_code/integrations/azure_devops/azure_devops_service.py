...
from wsai_code.integrations.azure_devops.service.branches import (
    AzureDevOpsBranchesMixin,
)
from wsai_code.integrations.azure_devops.service.features import (
    AzureDevOpsFeaturesMixin,
)
from wsai_code.integrations.azure_devops.service.prs import AzureDevOpsPRsMixin
from wsai_code.integrations.azure_devops.service.repos import AzureDevOpsReposMixin
from wsai_code.integrations.azure_devops.service.resolver import (
    AzureDevOpsResolverMixin,
)
from wsai_code.integrations.azure_devops.service.work_items import (
    AzureDevOpsWorkItemsMixin,
)
from wsai_code.integrations.protocols.http_client import HTTPClient
...
class AzureDevOpsServiceImpl(
    ...
    This is an extension point in WSAI CODE that allows applications to customize Azure DevOps
    integration behavior. Applications can substitute their own implementation by:
    1. Creating a class that inherits from GitService
    2. Implementing all required methods
    3. Setting WSAI_CODE_AZURE_DEVOPS_SERVICE_CLS environment variable
...
azure_devops_service_cls = os.environ.get(
    'WSAI_CODE_AZURE_DEVOPS_SERVICE_CLS',
    'wsai_code.integrations.azure_devops.azure_devops_service.AzureDevOpsServiceImpl',
)
