...
from wsai_code.integrations.azure_devops.service.base import AzureDevOpsMixinBase
from wsai_code.integrations.service_types import Comment, RequestMethod
...
class AzureDevOpsWorkItemsMixin(AzureDevOpsMixinBase):
    ...
    async def add_work_item_reaction(
        ...
        comment_text = f'{reaction_type} WSAI CODE is processing this work item...'
