...
from wsai_code.integrations.forgejo.service.base import ForgejoMixinBase
from wsai_code.integrations.service_types import RequestMethod, UnknownException
