from wsai_code.integrations.gitlab.service.base import GitLabMixinBase
from wsai_code.integrations.service_types import OwnerType, ProviderType, Repository
...
class GitLabReposMixin(GitLabMixinBase):
    ...
    async def search_repositories(
        ...
        order: str = 'desc',
        public: bool = False,
        app_mode: AppMode = AppMode.WSAI_CODE,
    ) -> list[Repository]:
        if public:
