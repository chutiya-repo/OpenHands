# WSAI CODE Architecture

This directory contains the core components of WSAI CODE.

For an overview of the system architecture, see the [architecture documentation](https://docs.wsai_code.dev/usage/architecture/backend) (v0 backend architecture).

## Classes

The key classes in WSAI CODE are:
...
* Server: brokers WSAI CODE sessions over HTTP, e.g. to drive the frontend
...
The EventStream serves as the backbone for all communication in WSAI CODE.
...
Please refer to the [documentation](https://docs.wsai_code.dev/usage/architecture/runtime) to learn more about `Runtime`.
