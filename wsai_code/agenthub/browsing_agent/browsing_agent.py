...
from wsai_code.agenthub.browsing_agent.response_parser import BrowsingResponseParser
...
class BrowsingAgent(Agent):
    ...
    def step(self, state: State) -> Action:
        ...
        # we should also send a message back to the user in WSAI CODE and call it a day
        if (
