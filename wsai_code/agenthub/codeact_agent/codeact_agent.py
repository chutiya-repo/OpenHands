...
import wsai_code.agenthub.codeact_agent.function_calling as codeact_function_calling
from wsai_code.agenthub.codeact_agent.tools.bash import create_cmd_run_tool
from wsai_code.agenthub.codeact_agent.tools.browser import BrowserTool
from wsai_code.agenthub.codeact_agent.tools.condensation_request import (
    CondensationRequestTool,
)
from wsai_code.agenthub.codeact_agent.tools.finish import FinishTool
from wsai_code.agenthub.codeact_agent.tools.ipython import IPythonTool
from wsai_code.agenthub.codeact_agent.tools.llm_based_edit import LLMBasedFileEditTool
from wsai_code.agenthub.codeact_agent.tools.str_replace_editor import (
    create_str_replace_editor_tool,
)
from wsai_code.agenthub.codeact_agent.tools.task_tracker import (
    create_task_tracker_tool,
)
from wsai_code.agenthub.codeact_agent.tools.think import ThinkTool
...
from wsai_code.core.message import Message
from wsai_code.events.action import AgentFinishAction, MessageAction
from wsai_code.events.event import Event
from wsai_code.llm.llm_utils import check_tools
from wsai_code.memory.condenser import Condenser
from wsai_code.memory.condenser.condenser import Condensation, View
...
from wsai_code.utils.prompt import PromptManager
...
class CodeActAgent(Agent):
    ...
    ![image](https://github.com/WSAI CODE/WSAI CODE/assets/38853559/92b622e3-72ad-4a61-8f41-8c040b6d5fb3)
