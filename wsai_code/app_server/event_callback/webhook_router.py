"""Event Callback router for WSAI CODE App Server."""
...
from wsai_code import tools  # type: ignore[attr-defined]
from wsai_code.agent_server.models import ConversationInfo, Success
...
from wsai_code.app_server.errors import AuthError
...
from wsai_code.app_server.user.auth_user_context import AuthUserContext
...
from wsai_code.sdk import ConversationExecutionStatus, Event
from wsai_code.sdk.event import ConversationStateUpdateEvent
from wsai_code.server.user_auth.default_user_auth import DefaultUserAuth
from wsai_code.server.user_auth.user_auth import (
...
async def get_secret(
    ...
    try:
        ...
        if user_id:
            ...
            # WSAI CODE (OSS mode) - use default user auth
