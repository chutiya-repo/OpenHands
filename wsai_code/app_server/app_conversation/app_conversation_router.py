"""Sandboxed Conversation router for WSAI CODE App Server."""
...
from wsai_code.app_server.user.specifiy_user_context import USER_CONTEXT_ATTR
...
from wsai_code.sdk.context.skills import KeywordTrigger, TaskTrigger
...
async def get_conversation_skills(
    ...
    - Global skills (WSAI CODE/skills/)
    - User skills (~/.wsai_code/skills/)
    - Organization skills (org/.wsai_code repository)
    - Repository skills (repo/.wsai_code/skills/ or .wsai_code/microagents/)
