...
from wsai_code.agent_server.models import WSAI CODEModel, SendMessageRequest
from wsai_code.agent_server.utils import WSAI CODEUUID, utc_now
from wsai_code.app_server.event_callback.event_callback_models import (
...
class AppConversationInfo(BaseModel):
    ...
    parent_conversation_id: WSAI CODEUUID | None = None
    sub_conversation_ids: list[WSAI CODEUUID] = Field(default_factory=list)
...
class AppConversationStartRequest(WSAI CODEModel):
...
class AppConversationStartTask(WSAI CODEModel):
    ...
    app_conversation_id: WSAI CODEUUID | None = Field(
...
class AppConversationStartTaskPage(WSAI CODEModel):
