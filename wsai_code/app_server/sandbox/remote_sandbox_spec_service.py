...
from wsai_code.app_server.sandbox.sandbox_spec_models import (
    SandboxSpecInfo,
)
...
def get_default_sandbox_specs():
    return [
        SandboxSpecInfo(
            ...
            command=['/usr/local/bin/wsai_code-agent-server', '--port', '60000'],
            initial_env={
                'OPENVSCODE_SERVER_ROOT': '/wsai_code/.openvscode-server',
                'LOG_JSON': 'true',
                'OH_ENABLE_VNC': '0',
