"""GraySwan security analyzer for WSAI CODE."""
...
from wsai_code.events.action.action import Action, ActionSecurityRisk
...
from wsai_code.security.grayswan.utils import convert_events_to_openai_messages
...
class GraySwanAnalyzer(SecurityAnalyzer):
    ...
    def _map_violation_to_risk(self, violation_score: float) -> ActionSecurityRisk:
        """Map GraySwan violation score to WSAI CODE ActionSecurityRisk."""
