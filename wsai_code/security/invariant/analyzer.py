...
from wsai_code.security.invariant.parser import TraceElement, parse_element
...
class InvariantAnalyzer(SecurityAnalyzer):
    ...
    container_name: str = 'wsai_code-invariant-server'
    image_name: str = 'ghcr.io/invariantlabs-ai/server:wsai_code'
