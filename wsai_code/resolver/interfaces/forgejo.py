...
from wsai_code.resolver.interfaces.issue import (
    Issue,
    IssueHandlerInterface,
    ReviewThread,
)
from wsai_code.resolver.utils import extract_issue_references
...
class ForgejoIssueHandler(IssueHandlerInterface):
    ...
    def reply_to_comment(self, pr_number: int, comment_id: str, reply: str) -> None:
        ...
        message = f'WSAI CODE reply to comment {comment_id}\n\n{reply}'
