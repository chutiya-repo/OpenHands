# The WSAI CODE Community

WSAI CODE is a community of engineers, academics, and enthusiasts reimagining software development for an AI-powered
world.
...
Everyone should feel empowered to contribute to WSAI CODE. Whether it’s by making a PR, hosting an event, sharing
feedback, or just asking a question, don’t hold back!

WSAI CODE gives everyone the building blocks to create state-of-the-art developer experiences. We experiment constantly
...
WSAI CODE is supported by the for-profit organization [All Hands AI, Inc](https://www.wsai_code.dev/).

All Hands was founded by three of the first major contributors to WSAI CODE:

- Xingyao Wang, a UIUC PhD candidate who got WSAI CODE to the top of the SWE-bench leaderboards
- Graham Neubig, a CMU Professor who rallied the academic community around WSAI CODE
- Robert Brennan, a software engineer who architected the user-facing features of WSAI CODE

All Hands is an important part of the WSAI CODE ecosystem. We’ve raised over $20M--mainly to hire developers and
researchers who can work on WSAI CODE full-time, and to provide them with expensive infrastructure. ([Join us!](https://allhandsai.applytojob.com/apply/))

But we see WSAI CODE as much larger, and ultimately more important, than All Hands. When our financial responsibility
...
At some point, we may transfer custody of WSAI CODE to an open source foundation. But for now,
