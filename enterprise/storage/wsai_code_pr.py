...
class WSAICodePR(Base):  # type: ignore
    """
    Represents a pull request created by WSAI CODE.
    """

    __tablename__ = 'wsai_code_prs'
    ...
    wsai_code_helped_author = Column(Boolean, nullable=True)
    num_wsai_code_commits = Column(Integer, nullable=True)
    num_wsai_code_review_comments = Column(Integer, nullable=True)
    num_wsai_code_general_comments = Column(Integer, nullable=True)
