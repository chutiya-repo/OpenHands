...
class OpenhandsPR(Base):  # type: ignore
    ...
    wsaicode_helped_author = Column(Boolean, nullable=True)
    num_wsaicode_commits = Column(Integer, nullable=True)
    num_wsaicode_review_comments = Column(Integer, nullable=True)
    num_wsaicode_general_comments = Column(Integer, nullable=True)
