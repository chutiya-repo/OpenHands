...
from wsai_code.server.shared import config, sio
...
async def keycloak_callback(
    ...
    if not keycloak_access_token or not keycloak_refresh_token:
        ...
        return _html_response(
            ...
            description=f'Please re-login into <a href="{HOST_URL}" style="color:#ecedee;text-decoration:underline;">WSAI CODE Cloud</a>. Then try <a href="https://docs.all-hands.dev/usage/cloud/slack-installation" style="color:#ecedee;text-decoration:underline;">installing the WSAI CODE Slack App</a> again',
            status_code=400,
        )
