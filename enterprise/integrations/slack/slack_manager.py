...
class SlackManager(Manager):
    ...
    async def authenticate_user(
        ...
        with session_maker() as session:
            ...
            # slack_view.slack_to_wsai_code_user = slack_user # attach user auth info to view
        ...
        if slack_user:
            ...
            # slack_view.saas_user_auth = await self._get_user_auth(slack_view.slack_to_wsai_code_user.keycloak_user_id)
    ...
    async def is_job_requested(
        ...
        if isinstance(slack_view, SlackUpdateExistingConversationView):
            ...
            user = slack_view.slack_to_wsai_code_user
    ...
    async def start_job(self, slack_view: SlackViewInterface):
        ...
        try:
            msg_info = None
            user_info: SlackUser = slack_view.slack_to_wsai_code_user
            try:
                logger.info(
