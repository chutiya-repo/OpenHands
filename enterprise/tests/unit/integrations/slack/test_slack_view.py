...
def slack_new_conversation_view(mock_slack_user, mock_user_auth):
    ...
    return SlackNewConversationView(
        ...
        slack_to_wsaicode_user=mock_slack_user,
...
class TestPausedSandboxResumption:
    ...
    @patch('wsaicode.app_server.event_callback.util.ensure_running_sandbox')
    @patch('wsaicode.app_server.event_callback.util.get_agent_server_url_from_sandbox')
