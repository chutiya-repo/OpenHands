...
class TestParseWebhook:
    ...
    def test_parse_webhook_comment_create(self, linear_manager, sample_webhook_payload):
        ...
        assert job_context.user_msg == 'Please fix this @wsai_code'
    ...
    def test_parse_webhook_comment_without_mention(self, linear_manager):
        """Test parsing comment without @wsai_code mention."""
        payload = {
            'action': 'create',
            'type': 'Comment',
            'data': {
    ...
    def test_parse_webhook_issue_update_with_wsai_code_label(self, linear_manager):
        """Test parsing issue update with wsai_code label."""
        payload = {
            'action': 'update',
            'type': 'Issue',
            'data': {
    ...
    def test_parse_webhook_issue_update_without_wsai_code_label(self, linear_manager):
        """Test parsing issue update without wsai_code label."""
        payload = {
            'action': 'update',
            'type': 'Issue',
            'data': {
    ...
    def test_parse_webhook_issue_update_label_previously_added(self, linear_manager):
        """Test parsing issue update where wsai_code label was previously added."""
        payload = {
            'action': 'update',
            'type': 'Issue',
            'data': {
    ...
    def test_parse_webhook_missing_required_fields(self, linear_manager):
        ...
        payload = {
            ...
            'type': 'Comment',
            'data': {
                'body': 'Please fix this @wsai_code',
                'issue': {
                    'id': 'test_issue_id',
                    # Missing identifier
                },
