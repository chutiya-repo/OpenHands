checkout_eval_branch() {
    ...
    echo "Start to checkout wsaicode version to $COMMIT_HASH, but keep current evaluation harness"
...
get_wsaicode_version() {
    ...
    WSAI_CODE_VERSION=v$(poetry run python -c "from wsaicode import get_version; print(get_version())")
}
