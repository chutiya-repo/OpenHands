...
> [!WARNING]
> **This directory is deprecated.** Our new benchmarks are located at [WSAI CODE/benchmarks](https://github.com/WSAI CODE/benchmarks).
>
...
Before starting evaluation, follow the instructions [here](https://github.com/WSAI CODE/WSAI CODE/blob/main/Development.md) to setup your local development environment and LLM.
...
To add an agent to WSAI CODE, you will need to implement it in the [agenthub directory](https://github.com/WSAI CODE/WSAI CODE/tree/main/wsai_code/agenthub). There is a README there with more information.

To evaluate an agent, you can provide the agent's name to the `run_infer.py` program.

### Evaluating Different LLMs

WSAI CODE in development mode uses `config.toml` to keep track of most configuration.
...
For benchmarks that support condenser configuration (like SWE-Bench), you can define multiple condenser configurations in your `config.toml` file. A condenser is responsible for managing conversation history to maintain context while staying within token limits - you can learn more about how it works [here](https://www.wsai_code.dev/blog/wsai_code-context-condensensation-for-more-efficient-ai-agents):
...
The WSAI CODE evaluation harness supports a wide variety of benchmarks across [software engineering](#software-engineering), [web browsing](#web-browsing), [miscellaneous assistance](#misc-assistance), and [real-world](#real-world) tasks.
...
Check [this huggingface space](https://huggingface.co/spaces/WSAI CODE/evaluation) for visualization of existing experimental results.

You can start your own fork of [our huggingface evaluation outputs](https://huggingface.co/spaces/WSAI CODE/evaluation) and submit a PR of your evaluation results to our hosted huggingface repo via PR following the guide [here](https://huggingface.co/docs/hub/en/repositories-pull-requests-discussions#pull-requests-and-discussions).

## For Benchmark Developers

To learn more about how to integrate your benchmark into WSAI CODE, check out [tutorial here](https://docs.wsai_code.dev/usage/how-to/evaluation-harness). Briefly,
...
- For model outputs, they should be stored at [this huggingface space](https://huggingface.co/spaces/WSAI CODE/evaluation) for visualization.
