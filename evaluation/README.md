...
> [!WARNING]
> **This directory is deprecated.** Our new benchmarks are located at [WSAI CODE/benchmarks](https://github.com/wsaicode/benchmarks).
>
...
Before starting evaluation, follow the instructions [here](https://github.com/wsaicode/wsaicode/blob/main/Development.md) to setup your local development environment and LLM.
...
To add an agent to WSAI CODE, you will need to implement it in the [agenthub directory](https://github.com/wsaicode/wsaicode/tree/main/wsaicode/agenthub). There is a README there with more information.
...
For benchmarks that support condenser configuration (like SWE-Bench), you can define multiple condenser configurations in your `config.toml` file. A condenser is responsible for managing conversation history to maintain context while staying within token limits - you can learn more about how it works [here](https://www.wsaicode.dev/blog/wsaicode-context-condensensation-for-more-efficient-ai-agents):
...
To learn more about how to integrate your benchmark into WSAI CODE, check out [tutorial here](https://docs.wsaicode.dev/usage/how-to/evaluation-harness). Briefly,
