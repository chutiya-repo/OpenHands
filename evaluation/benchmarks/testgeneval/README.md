...
- `git-version`: The git commit hash or release tag of WSAI CODE to evaluate (e.g., `HEAD` or `0.6.2`)
...
1. Fork [our HuggingFace evaluation outputs](https://huggingface.co/spaces/WSAI CODE/evaluation).
...
- [WSAI CODE Documentation](https://github.com/WSAI CODE/WSAI CODE)
- [HuggingFace Datasets](https://huggingface.co/datasets)

For any questions or issues, please open an issue in the [WSAI CODE repository](https://github.com/WSAI CODE/WSAI CODE/issues).
