...
from wsaicode.events.observation import BrowserOutputObservation, CmdOutputObservation
...
def get_config(
    ...
    config = get_wsaicode_config_for_eval(
        max_iterations=100,
        # we mount trajectories path so that trajectories, generated by WSAI CODE
...
if __name__ == '__main__':
    ...
    # 1) trajectory is dumped by WSAI CODE library (on host machine), but it's needed by
    ...
    config: WSAICodeConfig = get_config(
