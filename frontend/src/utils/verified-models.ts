...
// (e.g., they return `claude-sonnet-4-20250514` instead of `wsai_code/claude-sonnet-4-20250514`)
...
export const DEFAULT_WSAI_CODE_MODEL = "wsai_code/claude-opus-4-5-20251101";
