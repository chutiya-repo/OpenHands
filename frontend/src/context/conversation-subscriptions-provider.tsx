...
interface ConversationSubscriptionsContextType {
  ...
  getEventsForConversation: (conversationId: string) => WSAICodeParsedEvent[];
}
...
const isAgentStatusError = (event: unknown): event is WSAICodeParsedEvent =>
  isWSAICodeEvent(event) &&
