...
interface ConversationSubscriptionsContextType {
  ...
  getEventsForConversation: (conversationId: string) => WSAI CODEParsedEvent[];
}
...
const isAgentStatusError = (event: unknown): event is WSAI CODEParsedEvent =>
  isWSAI CODEEvent(event) &&
