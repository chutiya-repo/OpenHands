...
import { WSAI CODEEvent, ObservationEvent } from "#/types/v1/core";
...
const getActionEventTitle = (event: WSAI CODEEvent): React.ReactNode => {
...
const getObservationEventTitle = (event: WSAI CODEEvent): React.ReactNode => {
...
export const getEventContent = (event: WSAI CODEEvent | SkillReadyEvent) => {
