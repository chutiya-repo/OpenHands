...
import { WSAICodeEvent, ObservationEvent } from "#/types/v1/core";
...
const getActionEventTitle = (event: WSAICodeEvent): React.ReactNode => {
...
const getObservationEventTitle = (event: WSAICodeEvent): React.ReactNode => {
...
export const getEventContent = (event: WSAICodeEvent | SkillReadyEvent) => {
