...
const APP_TITLE_OSS = "WSAI CODE";
const APP_TITLE_SAAS = "WSAI CODE Cloud";

/**
 * Hook that returns the appropriate document title based on APP_MODE and current route.
 * - For conversation pages: "Conversation Title | WSAI CODE" or "Conversation Title | WSAI CODE Cloud"
 * - For other pages: "WSAI CODE" or "WSAI CODE Cloud"
 */
