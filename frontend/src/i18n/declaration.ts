...
export enum I18nKey {
  ...
  HOME$WSAI_CODE_DESCRIPTION = "HOME$WSAI_CODE_DESCRIPTION",
  ...
  BRANDING$WSAI_CODE = "BRANDING$WSAI_CODE",
  BRANDING$WSAI_CODE_LOGO = "BRANDING$WSAI_CODE_LOGO",
  ...
  CONFIGURATION$WSAI_CODE_WORKSPACE_DIRECTORY_INPUT_LABEL = "CONFIGURATION$WSAI_CODE_WORKSPACE_DIRECTORY_INPUT_LABEL",
  ...
  LLM$MODEL = "LLM$MODEL",
  CONFIGURATION$WSAI_CODE_WORKSPACE_DIRECTORY_INPUT_PLACEHOLDER = "CONFIGURATION$WSAI_CODE_WORKSPACE_DIRECTORY_INPUT_PLACEHOLDER",
  ...
  SETTINGS$NEED_WSAI_CODE_ACCOUNT = "SETTINGS$NEED_WSAI_CODE_ACCOUNT",
  ...
  SETTINGS$WSAI_CODE_API_KEY_HELP = "SETTINGS$WSAI_CODE_API_KEY_HELP",
  SETTINGS$WSAI_CODE_API_KEY_HELP_TEXT = "SETTINGS$WSAI_CODE_API_KEY_HELP_TEXT",
  SETTINGS$WSAI_CODE_API_KEY_HELP_SUFFIX = "SETTINGS$WSAI_CODE_API_KEY_HELP_SUFFIX",
  ...
  SYSTEM_MESSAGE_MODAL$WSAI_CODE_VERSION = "SYSTEM_MESSAGE_MODAL$WSAI_CODE_VERSION",
  ...
  SETTINGS$WSAI_CODE_API_KEYS = "SETTINGS$WSAI_CODE_API_KEYS",
  ...
  MICROAGENT_MANAGEMENT$WSAI_CODE_CAN_LEARN_ABOUT_REPOSITORIES = "MICROAGENT_MANAGEMENT$WSAI_CODE_CAN_LEARN_ABOUT_REPOSITORIES",
