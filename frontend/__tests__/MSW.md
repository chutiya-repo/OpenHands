...
> [!NOTE]
> **WSAI CODE vs SaaS Mode**
>
> WSAI CODE runs in two modes:
> - **WSAI CODE mode**: For local/self-hosted deployments where users provide their own LLM API keys and configure git providers manually
