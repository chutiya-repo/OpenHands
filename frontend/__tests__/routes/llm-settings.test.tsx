...
describe("Content", () => {
  ...
  describe("Advanced form", () => {
    ...
    it("should render the default advanced settings", async () => {
      ...
      expect(model).toHaveValue("wsai_code/claude-opus-4-5-20251101");
  ...
  describe("API key visibility in Basic Settings", () => {
    ...
    it("should hide API key input when switching from non-WSAI CODE to WSAI CODE provider in SaaS mode", async () => {
      ...
      await userEvent.click(provider);
      const wsaiCodeOption = screen.getByText("WSAI CODE");
      await userEvent.click(wsaiCodeOption);
...
describe("Form submission", () => {
  ...
  it("should clear advanced settings when saving basic settings", async () => {
    ...
    expect(saveSettingsSpy).toHaveBeenCalledWith(
      expect.objectContaining({
        llm_model: "wsai_code/claude-sonnet-4-20250514",
        llm_base_url: "",
