...
- First, research the WSAI CODE documentation which includes references to the Software Agent SDK: https://docs.wsaicode.dev/llms.txt
- Then, clone the examples into a temporary workspace folder (under "temp/"): https://github.com/wsaicode/software-agent-sdk/tree/main/examples/01_standalone_sdk
- Then, clone the SDK docs into the same temporary workspace folder: https://github.com/wsaicode/docs/tree/main/sdk
...
- Unless otherwise specified, default to this model: wsaicode/claude-sonnet-4-20250514. This is configurable through the LLM_BASE_MODEL environment variable.
