...
This agent helps create new microagents in the `.wsai_code/microagents` directory by providing guidance and templates.
...
- Create a markdown file in `.wsai_code/microagents/` with an appropriate name (e.g., `github.md`, `google_workspace.md`)
...
- [Example GitHub Skill](https://github.com/WSAI CODE/WSAI CODE/blob/main/skills/github.md)
