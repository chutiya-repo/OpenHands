...
This agent helps create new microagents in the `.wsaicode/microagents` directory by providing guidance and templates.
...
- Create a markdown file in `.wsaicode/microagents/` with an appropriate name (e.g., `github.md`, `google_workspace.md`)
...
- [Example GitHub Skill](https://github.com/wsaicode/wsaicode/blob/main/skills/github.md)
