...
from wsaicode.events.action.agent import AgentFinishAction
...
from wsaicode.storage.locations import get_conversation_agent_state_filename
...
class State:
    ...
    def to_llm_metadata(self, model_name: str, agent_name: str) -> dict:
        metadata = {
            ...
            'trace_version': wsaicode.__version__,
            'trace_user_id': self.user_id,
            'tags': [
                f'model:{model_name}',
                f'agent:{agent_name}',
                f'web_host:{os.environ.get("WEB_HOST", "unspecified")}',
                f'wsaicode_version:{wsaicode.__version__}',
            ],
        }
        return metadata
