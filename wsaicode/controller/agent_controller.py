...
from wsaicode.events.serialization.event import truncate_content
        ...
        if action.runnable:
            if self.state.confirmation_mode and (
                ...
                if self.agent.config.cli_mode:
                    ...
                    # See issue: https://github.com/wsaicode/wsaicode/issues/10464
