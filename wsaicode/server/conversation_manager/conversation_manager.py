...
class ConversationManager(ABC):
    """Abstract base class for managing conversations in WSAI CODE.
    ...
    This is an extension point in WSAI CODE, that applications built on it can use to modify behavior via server configuration, without modifying its code.
    ...
    The implementation class is instantiated via get_impl() in wsaicode.server.shared.py.
    """
