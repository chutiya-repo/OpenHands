...
from wsaicode.server.types import AppMode, ServerConfigInterface
...
class ServerConfig(ServerConfigInterface):
    ...
    settings_store_class: str = (
        'wsaicode.storage.settings.file_settings_store.FileSettingsStore'
    )
    secret_store_class: str = (
        'wsaicode.storage.secrets.file_secrets_store.FileSecretsStore'
    )
    conversation_store_class: str = (
        'wsaicode.storage.conversation.file_conversation_store.FileConversationStore'
    )
    ...
    monitoring_listener_class: str = 'wsaicode.server.monitoring.MonitoringListener'
    user_auth_class: str = (
        'wsaicode.server.user_auth.default_user_auth.DefaultUserAuth'
    )
