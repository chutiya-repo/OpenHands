...
from wsaicode.core.exceptions import LLMResponseError
from wsaicode.events.event import Event
from wsaicode.events.observation import CmdOutputMetadata
from wsaicode.events.serialization import event_to_dict
from wsaicode.llm.metrics import Metrics


class WSAICodeJSONEncoder(json.JSONEncoder):
...
_json_encoder = WSAICodeJSONEncoder()
...
def dumps(obj, **kwargs):
    ...
    if 'cls' not in encoder_kwargs:
        encoder_kwargs['cls'] = WSAICodeJSONEncoder
