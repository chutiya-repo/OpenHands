...
from wsaicode.events.event import Event, EventSource, RecallType
from wsaicode.events.observation.agent import (
    MicroagentKnowledge,
    RecallObservation,
)
from wsaicode.events.observation.empty import NullObservation
from wsaicode.events.stream import EventStream, EventStreamSubscriber
...
USER_MICROAGENTS_DIR = Path.home() / '.wsaicode' / 'microagents'
...
class Memory:
    ...
    def __init__(
        ...
        # Load user microagents from ~/.wsaicode/microagents/
    ...
    def _load_user_microagents(self) -> None:
        """Loads microagents from the user's home directory (~/.wsaicode/microagents/)
