...
DEFAULT_PYTHON_PREFIX = [
    '/wsaicode/micromamba/bin/micromamba',
    'run',
    '-n',
    'wsaicode',
    'poetry',
...
DEFAULT_MAIN_MODULE = 'wsaicode.runtime.action_execution_server'
...
def get_action_execution_server_startup_command(
    ...
    username = (
        override_username
        or RUNTIME_USERNAME
        or ('wsaicode' if app_config.run_as_wsaicode else 'root')
    )
    user_id = (
        override_user_id or RUNTIME_UID or (1000 if app_config.run_as_wsaicode else 0)
    )
