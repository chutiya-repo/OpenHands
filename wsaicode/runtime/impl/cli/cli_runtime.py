...
if sys.platform == 'win32':
    try:
        from wsaicode.runtime.utils.windows_exceptions import DotNetMissingError
        from wsaicode.runtime.utils.windows_bash import WindowsPowershellSession  # isort: skip
...
https://docs.wsai-code.dev/usage/windows-without-wsl
...
class CLIRuntime(Runtime):
    ...
    def __init__(
        ...
        if self.config.workspace_base is not None:
            ...
            self._workspace_path = tempfile.mkdtemp(
                prefix=f'wsaicode_workspace_{sid}_'
            )
    ...
    async def call_tool_mcp(self, action: MCPAction) -> Observation:
        ...
        from wsaicode.mcp.utils import call_tool_mcp as call_tool_mcp_handler
    ...
    async def delete(cls, conversation_id: str) -> None:
        ...
        prefix = f'wsaicode_workspace_{conversation_id}_'
