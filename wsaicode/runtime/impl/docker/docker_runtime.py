...
from wsaicode.core.logger import DEBUG, DEBUG_RUNTIME
...
from wsaicode.runtime.builder import DockerRuntimeBuilder
from wsaicode.runtime.impl.action_execution.action_execution_client import (
    ActionExecutionClient,
)
from wsaicode.runtime.impl.docker.containers import stop_all_containers
...
from wsaicode.runtime.utils.command import (
    DEFAULT_MAIN_MODULE,
    get_action_execution_server_startup_command,
)
from wsaicode.runtime.utils.log_streamer import LogStreamer
from wsaicode.runtime.utils.port_lock import PortLock, find_available_port_with_lock
from wsaicode.runtime.utils.runtime_build import build_runtime_image
from wsaicode.utils.async_utils import call_sync_from_async
from wsaicode.utils.shutdown_listener import add_shutdown_listener
from wsaicode.utils.tenacity_stop import stop_if_should_exit

CONTAINER_NAME_PREFIX = 'wsaicode-runtime-'
...
class DockerRuntime(ActionExecutionClient):
    ...
    def _process_volumes(self) -> dict[str, dict[str, str]]:
        ...
        # Legacy mounting with workspace_* parameters
            ...
            # e.g. result would be: {"/home/user/wsaicode/workspace": {'bind': "/workspace", 'mode': 'rw'}}
    ...
    def init_container(self) -> None:
        ...
        environment.update(
            {
                ...
                'WSAI_CODE_SESSION_ID': str(self.sid),
        ...
        try:
            ...
            self.container = self.docker_client.containers.run(
                ...
                ports=port_mapping,
                working_dir='/wsaicode/code/',  # do not change this!
    ...
    def close(self, rm_all_containers: bool | None = None) -> None:
        ...
        Parameters:
        - rm_all_containers (bool): Whether to remove all containers with the 'wsaicode-sandbox-' prefix
        """
        super().close()
