...
from wsaicode.core.logger import DEBUG
...
POD_NAME_PREFIX = 'wsaicode-runtime-'
POD_LABEL = 'wsaicode-runtime'


class KubernetesRuntime(ActionExecutionClient):
    """A Kubernetes runtime for WSAI CODE that works with Kind.
    ...
    def _get_runtime_pod_manifest(self):
        ...
        command = get_action_execution_server_startup_command(
            ...
            override_user_id=0,  # if we use the default of app_config.run_as_wsaicode then we cant edit files in vscode due to file perms.
