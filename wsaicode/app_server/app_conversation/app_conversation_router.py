...
from wsaicode.sdk.context.skills import KeywordTrigger, TaskTrigger
...
async def get_conversation_skills(
    ...
    - User skills (~/.wsaicode/skills/)
    - Organization skills (org/.wsaicode repository)
    - Repository skills (repo/.wsaicode/skills/ or .wsaicode/microagents/)
