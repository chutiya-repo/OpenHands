...
from wsaicode.agent_server.models import WSAICodeModel, SendMessageRequest
from wsaicode.agent_server.utils import WSAICodeUUID, utc_now
from wsaicode.app_server.event_callback.event_callback_models import (
...
class AppConversationInfo(BaseModel):
    ...
    parent_conversation_id: WSAICodeUUID | None = None
    sub_conversation_ids: list[WSAICodeUUID] = Field(default_factory=list)
...
class AppConversationStartRequest(WSAICodeModel):
...
class AppConversationStartTask(WSAICodeModel):
    ...
    app_conversation_id: WSAICodeUUID | None = Field(
...
class AppConversationStartTaskPage(WSAICodeModel):
