...
from wsaicode.sdk.utils.models import (
...
class CreateEventCallbackRequest(WSAICodeModel):
    conversation_id: WSAICodeUUID | None = Field(
        default=None,
        description=(
...
class EventCallbackPage(WSAICodeModel):
