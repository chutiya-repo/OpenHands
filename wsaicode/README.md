...
For an overview of the system architecture, see the [architecture documentation](https://docs.wsaicode.dev/usage/architecture/backend) (v0 backend architecture).
...
Please refer to the [documentation](https://docs.wsaicode.dev/usage/architecture/runtime) to learn more about `Runtime`.
