...
class WSAICodeMCPConfig:
    @staticmethod
    def add_search_engine(app_config: 'WSAICodeConfig') -> MCPStdioServerConfig | None:
    ...
    def create_default_mcp_server_config(
        ...
        """
        stdio_servers = []
        search_engine_stdio_server = WSAICodeMCPConfig.add_search_engine(config)
...
wsaicode_mcp_config_cls = os.environ.get(
    'WSAI_CODE_MCP_CONFIG_CLS',
    'wsaicode.core.config.mcp_config.WSAICodeMCPConfig',
)

WSAICodeMCPConfigImpl = get_impl(WSAICodeMCPConfig, wsaicode_mcp_config_cls)
