...
from wsaicode.core.logger import LOG_DIR
...
class LLMConfig(BaseModel):
    ...
    Attributes:
        ...
        custom_llm_provider: The custom LLM provider to use. This is undocumented in wsaicode, and normally not used. It is documented on the litellm side.
    ...
    openrouter_site_url: str = Field(default='https://docs.wsai-code.dev/')
    openrouter_app_name: str = Field(default='WSAI CODE')
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        # Azure issue: https://github.com/wsaicode/wsaicode/issues/7755
