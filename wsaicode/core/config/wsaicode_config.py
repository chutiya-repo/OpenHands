...
class WSAICodeConfig(BaseModel):
    ...
    Attributes:
        ...
        run_as_wsaicode: Whether to run as wsaicode.
    ...
    file_store_path: str = Field(default='~/.wsaicode')
    ...
    run_as_wsaicode: bool = Field(default=True)
    ...
    git_user_name: str = Field(
        default='wsaicode', description='Git user name for commits made by the agent'
    )
    git_user_email: str = Field(
        default='wsaicode@wsai-code.dev',
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        if not WSAICodeConfig.defaults_dict:  # Only set defaults_dict if it's empty
            WSAICodeConfig.defaults_dict = model_defaults_to_dict(self)
