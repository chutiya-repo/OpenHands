from wsaicode.integrations.gitlab.service.base import GitLabMixinBase
from wsaicode.integrations.service_types import OwnerType, ProviderType, Repository
