...
import wsaicode.agenthub.codeact_agent.function_calling as codeact_function_calling
from wsaicode.agenthub.codeact_agent.tools.bash import create_cmd_run_tool
from wsaicode.agenthub.codeact_agent.tools.browser import BrowserTool
from wsaicode.agenthub.codeact_agent.tools.condensation_request import (
    CondensationRequestTool,
)
from wsaicode.agenthub.codeact_agent.tools.finish import FinishTool
from wsaicode.agenthub.codeact_agent.tools.ipython import IPythonTool
from wsaicode.agenthub.codeact_agent.tools.llm_based_edit import LLMBasedFileEditTool
from wsaicode.agenthub.codeact_agent.tools.str_replace_editor import (
    create_str_replace_editor_tool,
)
from wsaicode.agenthub.codeact_agent.tools.task_tracker import (
    create_task_tracker_tool,
)
from wsaicode.agenthub.codeact_agent.tools.think import ThinkTool
...
from wsaicode.core.message import Message
from wsaicode.events.action import AgentFinishAction, MessageAction
from wsaicode.events.event import Event
from wsaicode.llm.llm_utils import check_tools
from wsaicode.memory.condenser import Condenser
from wsaicode.memory.condenser.condenser import Condensation, View
from wsaicode.memory.conversation_memory import ConversationMemory
from wsaicode.runtime.plugins import (
    AgentSkillsRequirement,
    JupyterRequirement,
    PluginRequirement,
)
from wsaicode.utils.prompt import PromptManager
...
class CodeActAgent(Agent):
    ...
    ![image](https://github.com/wsaicode/wsaicode/assets/38853559/92b622e3-72ad-4a61-8f41-8c040b6d5fb3)
