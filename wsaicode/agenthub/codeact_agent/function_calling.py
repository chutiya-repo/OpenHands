...
from wsaicode.agenthub.codeact_agent.tools.security_utils import RISK_LEVELS
...
from wsaicode.events.action.agent import CondensationRequestAction
...
from wsaicode.llm.tool_names import TASK_TRACKER_TOOL_NAME
...
def response_to_actions(
    ...
    if hasattr(assistant_msg, 'tool_calls') and assistant_msg.tool_calls:
        ...
        # Process each tool call to WSAI CODE action
