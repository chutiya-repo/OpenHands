...
from wsaicode.events.action.action import Action, ActionSecurityRisk
...
from wsaicode.security.invariant.parser import TraceElement, parse_element
...
class InvariantAnalyzer(SecurityAnalyzer):
    ...
    container_name: str = 'wsaicode-invariant-server'
    image_name: str = 'ghcr.io/invariantlabs-ai/server:wsaicode'
