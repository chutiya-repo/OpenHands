...
from wsaicode.resolver.interfaces.forgejo import ForgejoIssueHandler
...
from wsaicode.resolver.io_utils import (
    load_single_resolver_output,
)
from wsaicode.resolver.patching import apply_diff, parse_patch
from wsaicode.resolver.resolver_output import ResolverOutput
from wsaicode.resolver.utils import identify_token
...
PR_SIGNATURE = (
    'Automatic fix generated by [WSAI CODE](https://github.com/wsaicode/wsaicode/) 🙌'
)
...
def make_commit(
    ...
    issue: Issue,
    issue_type: str,
    git_user_name: str = 'wsaicode',
    git_user_email: str = 'wsaicode@wsai-code.dev',
) -> None:
...
def send_pull_request(
    ...
    base_branch_name = f'wsaicode-fix-issue-{issue.number}'
