...
@patch('wsaicode.resolver.send_pull_request.ForgejoIssueHandler')
...
def test_send_pull_request_forgejo(
    ...
    service_context_instance.get_branch_name.return_value = 'wsaicode-fix-issue-7'
