...
from wsai_code.app_server.sandbox.preset_sandbox_spec_service import (
...
class TestDockerSandboxSpecServiceInjector:
    ...
    @patch('wsai_code.app_server.sandbox.docker_sandbox_spec_service.get_docker_client')
    ...
    def test_get_default_sandbox_specs(self):
        ...
        assert specs[0].id.startswith('ghcr.io/wsai_code/agent-server:')
    ...
    @patch(
        'wsai_code.app_server.sandbox.docker_sandbox_spec_service._global_docker_client',
        None,
    )
    ...
    def test_get_docker_client_reuses_existing_client(
        ...
        import wsai_code.app_server.sandbox.docker_sandbox_spec_service as module
    ...
    @patch('wsai_code.app_server.sandbox.docker_sandbox_spec_service.get_docker_client')
    @patch('wsai_code.app_server.sandbox.docker_sandbox_spec_service._logger')
