...
def _setup_common_mocks():
    ...
    return {
        'config': patch('wsai_code.server.routes.manage_conversations.config'),
        'conversation_manager': patch(
            'wsai_code.server.routes.manage_conversations.conversation_manager'
        ),
        'wait_all': patch(
            'wsai_code.server.routes.manage_conversations.wait_all',
...
async def test_get_microagent_management_conversations_success():
    ...
    with (
        ...
        patch('wsai_code.server.routes.manage_conversations.config') as mock_config,
        patch(
            'wsai_code.server.routes.manage_conversations.conversation_manager'
        ) as mock_conv_mgr,
        patch(
...
async def test_get_microagent_management_conversations_no_results():
    ...
    with (
        patch('wsai_code.server.routes.manage_conversations.ProviderHandler'),
        patch('wsai_code.server.routes.manage_conversations.config') as mock_config,
        patch(
            'wsai_code.server.routes.manage_conversations.conversation_manager'
        ) as mock_conv_mgr,
