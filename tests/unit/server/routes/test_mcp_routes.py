...
from wsai_code.server.routes.mcp import get_conversation_link
...
async def test_get_conversation_link_non_saas_mode():
    ...
    with patch('wsai_code.server.routes.mcp.server_config') as mock_config:
...
async def test_get_conversation_link_saas_mode():
    ...
    # Test with SAAS mode
    with (
        patch('wsai_code.server.routes.mcp.server_config') as mock_config,
        patch(
            'wsai_code.server.routes.mcp.CONVERSATION_URL',
