...
from wsaicode.storage.secrets.secrets_store import SecretsStore
from wsaicode.storage.settings.file_settings_store import FileSettingsStore
...
def test_client():
    ...
    with (
        ...
        patch(
            'wsaicode.server.user_auth.user_auth.UserAuth.get_instance',
            return_value=MockUserAuth(),
        ),
        patch(
            'wsaicode.storage.settings.file_settings_store.FileSettingsStore.get_instance',
