...
async def test_start_endpoint_passes_provider_tokens(
    ...
    with patch(
        ...
        with patch(
            'wsaicode.server.services.conversation_service.SettingsStoreImpl.get_instance'
        ) as mock_settings_store_cls:
            with patch(
                'wsaicode.server.services.conversation_service.SecretsStoreImpl.get_instance'
            ) as mock_secrets_store_cls:
                with patch(
                    'wsaicode.server.services.conversation_service.server_config'
