...
from wsaicode.integrations.provider import ProviderHandler, ProviderToken, ProviderType
from wsaicode.integrations.service_types import AuthenticationError, Repository
...
async def test_clone_or_init_repo_github_with_token(temp_dir, monkeypatch):
    ...
    assert 'git checkout -b wsaicode-workspace-' in checkout_cmd
