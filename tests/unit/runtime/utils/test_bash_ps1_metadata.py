...
###PS1JSON###
{
  ...
  "py_interpreter_path": "/home/runner/.cache/pypoetry/virtualenvs/wsaicode-ai-ULPBlkAi-py3.12/bin/python"
}
###PS1END###
"""
    matches = CmdOutputMetadata.matches_ps1_metadata(ps1_str)
    ...
    assert (
        ...
        == '/home/runner/.cache/pypoetry/virtualenvs/wsaicode-ai-ULPBlkAi-py3.12/bin/python'
    )
