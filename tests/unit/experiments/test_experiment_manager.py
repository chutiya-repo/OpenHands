...
from wsaicode.app_server.sandbox.sandbox_models import SandboxInfo, SandboxStatus
...
class TestExperimentManagerIntegration:
    ...
    @patch('wsaicode.experiments.experiment_manager.ExperimentManagerImpl')
    ...
    async def test_experiment_manager_called_with_correct_parameters_in_context__noop_pass_through(
        ...
        with (
            ...
            patch(
                'wsaicode.app_server.app_conversation.live_status_app_conversation_service.uuid4',
