...
from wsaicode.resolver.send_pull_request import make_commit
...
def test_pr_title_with_quotes(monkeypatch):
    ...
    monkeypatch.setattr(
        'wsaicode.resolver.interfaces.github.GithubIssueHandler.branch_exists',
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print('Sending PR...')
        from wsaicode.resolver.send_pull_request import send_pull_request
