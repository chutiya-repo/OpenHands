...
from wsai_code.resolver.send_pull_request import make_commit
...
def test_pr_title_with_quotes(monkeypatch):
    ...
    monkeypatch.setattr(
        'wsai_code.resolver.interfaces.github.GithubIssueHandler.branch_exists',
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print('Sending PR...')
        from wsai_code.resolver.send_pull_request import send_pull_request
