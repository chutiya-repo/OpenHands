...
from wsai_code.events.observation import BrowserOutputObservation
...
from wsai_code.memory.condenser.condenser import Condensation, RollingCondenser, View
from wsai_code.memory.condenser.impl import (
...
def mock_llm_registry(mock_llm, mock_conversation_stats) -> LLMRegistry:
    ...
    # Create an actual LLMRegistry with a basic WSAI CODEConfig
