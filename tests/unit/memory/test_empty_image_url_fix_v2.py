...
from wsai_code.core.message import ImageContent
...
def test_empty_image_url_handling():
    ...
    prompt_manager = PromptManager(
        prompt_dir='wsai_code/agenthub/codeact_agent/prompts'
    )
...
def test_ipython_empty_image_url_handling():
    ...
    from wsai_code.events.observation.commands import IPythonRunCellObservation
