...
from wsaicode.agenthub.codeact_agent.codeact_agent import CodeActAgent
from wsaicode.agenthub.codeact_agent.function_calling import (
    response_to_actions as codeact_response_to_actions,
)
from wsaicode.agenthub.codeact_agent.tools import (
    BrowserTool,
    IPythonTool,
...
from wsaicode.agenthub.codeact_agent.tools.browser import (
    _BROWSER_DESCRIPTION,
    _BROWSER_TOOL_DESCRIPTION,
)
from wsaicode.agenthub.readonly_agent.function_calling import (
    response_to_actions as readonly_response_to_actions,
)
from wsaicode.agenthub.readonly_agent.readonly_agent import ReadOnlyAgent
from wsaicode.agenthub.readonly_agent.tools import (
    GlobTool,
    GrepTool,
)
from wsaicode.controller.state.state import State
from wsaicode.core.config import AgentConfig, LLMConfig
from wsaicode.core.config.wsaicode_config import WSAICodeConfig
from wsaicode.core.exceptions import FunctionCallNotExistsError
from wsaicode.core.message import ImageContent, Message, TextContent
...
from wsaicode.events.tool import ToolCallMetadata
from wsaicode.llm.llm_registry import LLMRegistry
from wsaicode.memory.condenser import View
...
def test_get_system_message(create_llm_registry):
    ...
    assert 'You are WSAI CODE agent' in result.content
