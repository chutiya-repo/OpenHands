...
from wsaicode.events.action import LoopRecoveryAction, MessageAction
from wsaicode.events.observation import LoopDetectionObservation
...
class TestAgentControllerLoopRecovery:
    ...
    async def test_controller_truncates_history_during_loop_recovery(
        ...
        from wsaicode.events.observation import CmdOutputObservation, NullObservation
