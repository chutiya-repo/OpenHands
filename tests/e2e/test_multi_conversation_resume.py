...
def test_multi_conversation_resume(page: Page):
    ...
    1. Navigate to WSAI CODE (assumes GitHub token is already configured)
    2. Select the WSAI CODE repository
    ...
    # Navigate to the WSAI CODE application
    print('Step 1: Navigating to WSAI CODE application...')
    ...
    # Step 2: Select the WSAI CODE repository
    print('Step 2: Selecting wsai_code-agent/WSAI CODE repository...')
    ...
    try:
        ...
        page.keyboard.type('wsai_code-agent/WSAI CODE')
    ...
    option_selectors = [
        '[data-testid="repo-dropdown"] [role="option"]:has-text("wsai_code-agent/WSAI CODE")',
        '[data-testid="repo-dropdown"] [role="option"]:has-text("WSAI CODE")',
        '[data-testid="repo-dropdown"] div[id*="option"]:has-text("wsai_code-agent/WSAI CODE")',
        '[data-testid="repo-dropdown"] div[id*="option"]:has-text("WSAI CODE")',
        '[role="option"]:has-text("wsai_code-agent/WSAI CODE")',
        '[role="option"]:has-text("WSAI CODE")',
        'div:has-text("wsai_code-agent/WSAI CODE"):not([id="aria-results"])',
        'div:has-text("WSAI CODE"):not([id="aria-results"])',
    ]
                ...
                try:
                    ...
                    if content and len(content.strip()) > 10:
                        ...
                        if (
                            ...
                            and (
                                'wsai_code' in content_lower
                                or 'wsai_code-ai' in content_lower
                            )
                        ):
                            print(
                            ...
                            if name_match:
                                ...
                                # Fallback: look for "wsai_code" variations in the content
                                if 'wsai_code-ai' in content_lower:
                                    project_name = 'wsai_code-ai'
                                elif 'wsai_code' in content_lower:
                                    project_name = 'wsai_code'
