...
poetry run pytest test_settings.py::test_github_token_configuration test_conversation.py::test_conversation_start -v --base-url=https://my-wsaicode-instance.com
...
2. Selects the "wsaicode-agent/WSAI CODE" repository
...
2. Check the logs in `/tmp/wsaicode-e2e-test.log` and `/tmp/wsaicode-e2e-build.log`
