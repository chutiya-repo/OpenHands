...
This test navigates to WSAI CODE, configures the LLM API key if prompted,
...
def test_github_token_configuration(page: Page, base_url: str):
    ...
    try:
        ...
        # This means the GitHub token is already configured in ~/.wsai_code/settings.json
