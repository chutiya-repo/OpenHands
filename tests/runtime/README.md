...
This folder contains integration tests that verify the functionality of WSAI CODE' runtime environments and their interactions with various tools and features.
...
- `RUN_AS_WSAI_CODE`: Set to 'True' to run tests as wsai_code user (default), 'False' for root
