...
def test_get_system_info():
    ...
    with patch(
        'wsaicode.runtime.utils.system_stats.get_system_stats'
    ) as mock_get_stats:
...
def test_idle_time_calculation(mock_time):
    ...
    import wsaicode.runtime.utils.system_stats

    importlib.reload(wsaicode.runtime.utils.system_stats)

    # Get system info
    from wsaicode.runtime.utils.system_stats import get_system_info
