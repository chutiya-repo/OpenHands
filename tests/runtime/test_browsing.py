...
def test_browser_disabled(temp_dir, runtime_cls, run_as_wsai_code, dynamic_port):
    runtime, _ = _load_runtime(
        temp_dir, runtime_cls, run_as_wsai_code, enable_browser=False
    )
...
def test_simple_browse(temp_dir, runtime_cls, run_as_wsai_code, dynamic_port):
...
def test_browser_file_upload(temp_dir, runtime_cls, run_as_wsai_code, dynamic_port):
...
def test_read_pdf_browse(temp_dir, runtime_cls, run_as_wsai_code):
    runtime, config = _load_runtime(
        temp_dir, runtime_cls, run_as_wsai_code, enable_browser=True
    )
    try:
...
def test_read_png_browse(temp_dir, runtime_cls, run_as_wsai_code):
    runtime, config = _load_runtime(
        temp_dir, runtime_cls, run_as_wsai_code, enable_browser=True
    )
    try:
...
def test_download_file(temp_dir, runtime_cls, run_as_wsai_code, dynamic_port):
